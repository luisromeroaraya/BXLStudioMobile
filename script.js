$(document).ready(function(){
    ...
    var language = {
        ...
        es: {
            ...
            aboutText: "Sesión de grabación multipista (dentro y fuera de Bruselas). Grabación simultánea de hasta 16 pistas en el lugar de tu conveniencia. Posibilidad de grabar todos juntos o pista por pista. Ideal para desarrollar tus primeros demos, grabar tu sesión en vivo o streamear tu concierto. Al final de la sesión, recibirás una pre-mezcla de la grabación y todas las pistas de audio por separado. El servicio de mezcla por canción tiene un costo adicional.",
