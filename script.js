$(document).ready(function(){
    ...
    function changeLanguage() {
        if (this.innerHTML == "EN") {
            ...
            document.getElementById("selected-lang").innerHTML = "<img src='images/gb.svg' width='32' alt='EN'></img>EN";
        }
        if (this.innerHTML == "ES") {
            ...
            document.getElementById("selected-lang").innerHTML = "<img src='images/es.svg' width='32' alt='ES'></img>ES";
        }
        if (this.innerHTML == "FR") {
            ...
            document.getElementById("selected-lang").innerHTML = "<img src='images/fr.svg' width='32' alt='FR'></img>FR";
        }
        if (this.innerHTML == "NL") {
            ...
            document.getElementById("selected-lang").innerHTML = "<img src='images/nl.svg' width='32' alt='NL'></img>NL";
